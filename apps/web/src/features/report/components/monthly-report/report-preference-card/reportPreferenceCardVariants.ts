...
> = {
  'night-watch': {
    ...
    shareClassName: 'report-preference-share--night-watch',
  ...
  'food-nomad': {
    ...
    shareClassName: 'report-preference-share--food-nomad',
  ...
  'local-regular': {
    ...
    shareClassName: 'report-preference-share--local-regular',
  ...
  'alley-explorer': {
    ...
    shareClassName: 'report-preference-share--alley-explorer',
