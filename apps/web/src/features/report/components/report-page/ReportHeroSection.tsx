...
export default function ReportHeroSection({
  ...
  return (
    <section className="relative h-63">
      ...
      <BackButton className="absolute top-0 left-4 z-10" onClick={onBack} />
      <div className="absolute inset-x-0 top-18 z-10 flex items-end justify-between px-7.5">
